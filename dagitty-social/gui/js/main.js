...
var GUI = {
	...
	set_question_label : function() { //TODO refactor
		var vid = document.getElementById("variable_id").value

		// change vertex value...
		var cur = Model.dag.getVertex(vid)
		cur.questionlabel = document.getElementById("variable_question_label").value
		// console.log(cur);

		DAGittyControl.setGraph( Model.dag ); // trigges to refresh the rendering
	},
	set_input_label : function() { //TODO refactor
		var vid = document.getElementById("variable_id").value

		// change vertex value...
		var cur = Model.dag.getVertex(vid)
		cur.inputlabel = document.getElementById("variable_input_label").value
		// console.log(cur);

		DAGittyControl.setGraph( Model.dag ); // trigges to refresh the rendering
	},
	set_input_sort : function() { //TODO refactor
		var vid = document.getElementById("variable_id").value

		// change vertex value...
		var cur = Model.dag.getVertex(vid)
		cur.inputsort = document.getElementById("variable_input_sort").value
		// console.log(cur);

		DAGittyControl.setGraph( Model.dag ); // trigges to refresh the rendering
	},
	set_input_defaultvalue : function() { //TODO refactor
		var vid = document.getElementById("variable_id").value

		// change vertex value...
		var cur = Model.dag.getVertex(vid)
		cur.inputdefaultvalue = document.getElementById("variable_input_defaultvalue").value
		// console.log(cur);

		DAGittyControl.setGraph( Model.dag ); // trigges to refresh the rendering
	},
	set_answer_label : function() {
		var vid = document.getElementById("variable_id").value

		// change vertex value...
		var cur = Model.dag.getVertex(vid)
		cur.answerlabel = document.getElementById("variable_answer_label").value
		// console.log(cur);

		DAGittyControl.setGraph( Model.dag ); // trigges to refresh the rendering
	},
	set_answer_value : function() {
		var vid = document.getElementById("variable_id").value

		// change vertex value...
		var cur = Model.dag.getVertex(vid)
		cur.answervalue = document.getElementById("variable_answer_value").value
		// console.log(cur);

		DAGittyControl.setGraph( Model.dag ); // trigges to refresh the rendering
	},
	set_decision_calculation : function() {
		var vid = document.getElementById("variable_id").value

		// change vertex value...
		var cur = Model.dag.getVertex(vid)
		cur.decisioncalculation = document.getElementById("variable_decision_calculation").value
		// console.log(cur);

		DAGittyControl.setGraph( Model.dag ); // trigges to refresh the rendering
	},
	set_result_label : function() { //TODO refactor
		var vid = document.getElementById("variable_id").value

		// change vertex value...
		var cur = Model.dag.getVertex(vid)
		cur.resultlabel = document.getElementById("variable_result_label").value
		// console.log(cur);

		DAGittyControl.setGraph( Model.dag ); // trigges to refresh the rendering
	},
	set_result_calculation : function() { //TODO refactor
		var vid = document.getElementById("variable_id").value

		// change vertex value...
		var cur = Model.dag.getVertex(vid)
		cur.resultcalculation = document.getElementById("variable_result_calculation").value
		// console.log(cur);

		DAGittyControl.setGraph( Model.dag ); // trigges to refresh the rendering
	},
	set_answer_sort : function() {
		var vid = document.getElementById("variable_id").value

		// change vertex value...
		var cur = Model.dag.getVertex(vid)
		cur.answersort = document.getElementById("variable_answer_sort").value

		DAGittyControl.setGraph( Model.dag ); // trigges to refresh the rendering
	},
	set_addl_info : function() {
		var vid = document.getElementById("variable_id").value

		// change vertex value...
		var cur = Model.dag.getVertex(vid)
			cur.addlinfo = document.getElementById("variable_addl_info").value
	...
	refresh_variable_status : function(){
		...
		document.getElementById("variable_question").checked = Model.dag.isQuestion(vid)
		document.getElementById("variable_input").checked = Model.dag.isInput(vid)
		document.getElementById("variable_answer").checked = Model.dag.isAnswer(vid)
		document.getElementById("variable_decision").checked = Model.dag.isDecision(vid)
		document.getElementById("variable_result").checked = Model.dag.isResult(vid)
	},
